...
impl GroupOrderElement {
    ...
    pub fn zero() -> BlsResult<GroupOrderElement> {
...
impl Pair {
    ...
    #[allow(unused)]
    pub fn new_unity() -> BlsResult<Self> {
        Ok(Self {
            pair: FP12::new_int(1),
        })
    }
    ...
    pub fn from_string(val: &str) -> BlsResult<Pair> {
...
fn pre_validate_point(val: &str, components: usize) -> BlsResult<()> {
